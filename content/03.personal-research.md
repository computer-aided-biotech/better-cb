...
<table>
    ...
    <tbody>
        <tr>
            <td rowspan=5><b>Step 4:</b> Follow coding good practices</td>
            <td rowspan=1>Coding style</td>
            <td>&bull; Styling guides: PEP-8 (Python), Google (Python, R) <br />&bull; Linters<br />&bull; Variable naming: camelCase, PascalCase, snake_case<br />&bull; Commenting: Header comment, function header, in line<br />&bull; Modularity: Modules, packages, libraries</td>
        </tr>
        <tr>
