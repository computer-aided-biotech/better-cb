...
After dealing with steps one to three, finally comes writing code. Coding, however, requires a series of good practices to ensure sustainability and reproducibility that your future self and collaborators (as we will discuss in Level 2) will appreciate. 

When designing your code strive for modularity. This is especially relevant if your research goal involves designing new programs. Modularity promotes code readability and reusability—enabling your code to be used by you or others in future and maybe unrelated applications. 

Same as grammar, each programming language has rules that make the code more readable. The way that you write code is known as styling. 

------

* commenting, log de cambios, funciones, decisiones en codigo, standard styling, modularity
* version control
